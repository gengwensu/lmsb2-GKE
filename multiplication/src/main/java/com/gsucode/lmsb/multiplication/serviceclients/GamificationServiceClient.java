package com.gsucode.lmsb.multiplication.serviceclients;

import com.gsucode.lmsb.multiplication.challenge.ChallengeAttempt;
import com.gsucode.lmsb.multiplication.challenge.ChallengeSolvedDTO;
...
public class GamificationServiceClient {
    ...
    public boolean sendAttempt(final ChallengeAttempt attempt) {
        try {
            ...
            log.info("Multiplication, sendAttempt, dto = {}", dto);
